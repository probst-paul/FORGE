...
public class FirstHourBreachEventDetector implements EventDetector {
    ...
    public List<MarketEvent> detect(
        ...
        Map<EventKey, MarketEvent> firstEventByKey = new HashMap<>();
        for (TradeTick tick : sortedTicks) {
            ...
            MarketEvent event = detectBreach(feature, tick, context.getTradingDay());
            if (event != null) {
    ...
    private MarketEvent detectBreach(SessionRangeFeature feature, TradeTick tick, LocalDate sessionDate) {
