...
public class StaticFuturesInstrumentSpecProvider implements FuturesInstrumentSpecProvider {
    ...
    public StaticFuturesInstrumentSpecProvider() {
        ...
        add(specs, new FuturesInstrumentSpec("ES", "E-mini S&P 500", 0.25, 12.50));
        add(specs, new FuturesInstrumentSpec("NQ", "E-mini Nasdaq-100", 0.25, 5.00));
        add(specs, new FuturesInstrumentSpec("YM", "E-mini Dow", 1.00, 5.00));
        add(specs, new FuturesInstrumentSpec("RTY", "E-mini Russell 2000", 0.10, 5.00));
        add(specs, new FuturesInstrumentSpec("CL", "Crude Oil", 0.01, 10.00));
