...
FORGE is in early architectural development. Implemented paths include SCID-to-PostgreSQL ingestion, rollover-aware catalog availability, exact tick-based price storage, event statistics, and a basic backtest simulation path.
