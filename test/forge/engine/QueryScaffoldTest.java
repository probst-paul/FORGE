...
class QueryScaffoldTest {
    ...
    class EventStatisticsQueryRunnerTests {
        ...
        void runsFullEventStatisticsQueryPipeline() {
            ...
            InMemoryEngineDerivedDataStore derivedDataStore = new InMemoryEngineDerivedDataStore();
        ...
        void facadeRunsEventStatisticsQuery() {
            ...
            InMemoryTickDataProvider tickDataProvider = new InMemoryTickDataProvider(ticks);
            QueryService queryService = new QueryService();
            QueryTradeTickSource tickSource = new InMemoryEngineTradeTickSource(tickDataProvider);
            InMemoryEngineDerivedDataStore derivedDataStore = new InMemoryEngineDerivedDataStore();
            FacadeForgeEngine facade = new FacadeForgeEngine(
                    queryService,
        ...
        void reusesStoredFeaturesAndEventsOnSubsequentRuns() {
            ...
            InMemoryEngineTradeTickSource tickSource = new InMemoryEngineTradeTickSource(new InMemoryTickDataProvider(ticks));
            EventStatisticsQueryRunner runner = new EventStatisticsQueryRunner(
                    tickSource,
                    new InMemoryEngineDerivedDataStore(),
                    new FeatureBuildService(),
        ...
        private class InMemoryEngineTradeTickSource implements QueryTradeTickSource {
            private final InMemoryTickDataProvider tickDataProvider;
            private int openReaderCount;

            private InMemoryEngineTradeTickSource(InMemoryTickDataProvider tickDataProvider) {
        ...
        private class InMemoryEngineDerivedDataStore implements QueryDerivedDataStore {
